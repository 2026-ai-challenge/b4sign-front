    ...
    <>
      ...
      <div style={{ padding: "8px 20px 40px", flex: 1 }}>
        ...
        <Section title="제4조 (면책조항)">
          ...
          삼아 발생한 손해에 대해서는 <span style={TODO}>회사의 고의 또는 중대한 과실이 없는 한</span>{" "}
          책임을 지지 않습니다. 본 서비스의 분석 결과는 참고 정보이며 법률 자문이 아닙니다. 중요한 계약 결정은 반드시 법무사·변호사 등 전문가와
          상의하시기 바랍니다.
        </Section>
        ...
        <Section title="제5조 (회사 정보 및 문의)">
          ...
          <br />
          주소 <span style={TODO}>온라인 서비스 (별도 사업장 없음)</span>
          <br />
          문의처 <span style={TODO}>dlckdgh0523@gmail.com</span>
        </Section>

        <Section title="제6조 (분쟁 해결)">
          서비스 이용과 관련해 발생한 분쟁은 대한민국 법령에 따르며, 관할 법원은{" "}
          <span style={TODO}>민사소송법에 따른 관할 법원</span>으로 합니다.
        </Section>
      </div>
    </>
  );
